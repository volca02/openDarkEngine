...
struct DarkDBPropAIWtchPnt
{
	...
	/*struct DarkPScriptCommand	extra2[8];	Even more extra in Dark2, leave it up to the app to fill out */
};
...
/* i.e. if clockwise, haltclose = closedangle + 2 and haltopen = openangle - 2 */
	SCoord	haltclose;
	SCoord	haltopen;
};
#pragma pack(pop)
