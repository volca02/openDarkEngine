 ...
 * Compiles link (Relation) and property definition scripts, and registers the
 * property and relation definitions to the appropriate classes. These scripts
 * define various aspects of Link/Property behaviour
 */
...
protected:
    ...
    struct CompileState {
        ...
        Ogre::String name;
        Ogre::String label;
        // Property data type (defaults to "")
        Ogre::String ptype;
        Ogre::String dtypename;
        Ogre::String inherit;

        // TODO: If query cache is implemented, and selection of such is
        // possible, implement query cache record and registration
        bool hidden;
        bool no_data;
        int fake_size;
    ...
    /** get the typedef from binary service. First the given namespace's, then
     * the global if not found in namespace */
    ...
    */
    ...
    /// Parses cached info
    void parseCached(void);

    /// Parses data type info
    void parseType(void);
};
} // namespace Opde
