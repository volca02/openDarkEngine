...
namespace Ogre {
	...
	// ---------------------------------------------------------------------------------------------------
	DataStreamPtr CustomImageCodec::encode(MemoryDataStreamPtr& input, CodecDataPtr& pData) const {
		OGRE_EXCEPT(Exception::ERR_NOT_IMPLEMENTED, "Cannot code with CustomImageCodec", "CustomImageCodec::code");
	}


	// ---------------------------------------------------------------------------------------------------
	void CustomImageCodec::encodeToFile(MemoryDataStreamPtr& input, const String& outFileName, CodecDataPtr& pData) const {
