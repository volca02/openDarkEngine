...
#define DARK_MOUSE_EVENT (1 << 25)
	 ...
	 */
	class OPDELIB_EXPORT InputService : public ServiceImpl<InputService>, public LoopClient
	{
		public:
		...
		protected:
			...
			*/
			...
			void processKeyEvent(SDL_Keycode keyCode, unsigned int modifiers, InputEventType t);
